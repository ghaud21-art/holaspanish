...
const GRAMMAR_B1_CHAPTERS = [
  { num: 1, titleEs: 'El género del sustantivo', titleKr: '명사의 성',
    examples: [{ es: 'El chico es alto.', kr: '그 남자아이는 키가 커요.' }, { es: 'La chica es alta.', kr: '그 여자아이는 키가 커요.' }] },
  { num: 2, titleEs: 'El número del sustantivo', titleKr: '명사의 수',
    examples: [{ es: 'Tengo un libro.', kr: '책 한 권이 있어요.' }, { es: 'Tengo tres libros.', kr: '책 세 권이 있어요.' }] },
  { num: 3, titleEs: 'Los artículos indefinido y definido', titleKr: '부정 관사와 정관사',
    examples: [{ es: 'Compro un libro.', kr: '책 한 권을 사요.' }, { es: 'El libro es interesante.', kr: '그 책은 재미있어요.' }] },
  { num: 4, titleEs: 'Los adjetivos', titleKr: '형용사',
    examples: [{ es: 'La casa es grande.', kr: '그 집은 커요.' }, { es: 'Los coches son caros.', kr: '그 차들은 비싸요.' }] },
  { num: 5, titleEs: 'Los pronombres personales y el verbo ser', titleKr: '주격 인칭 대명사와 동사 ser',
    examples: [{ es: 'Yo soy estudiante.', kr: '나는 학생이에요.' }, { es: 'Ellos son médicos.', kr: '그들은 의사예요.' }] },
  { num: 6, titleEs: 'El verbo estar', titleKr: '동사 estar',
    examples: [{ es: 'Estoy en casa.', kr: '나는 집에 있어요.' }, { es: 'Ella está cansada.', kr: '그녀는 피곤해요.' }] },
  { num: 7, titleEs: 'El verbo hay', titleKr: '동사 hay',
    examples: [{ es: 'Hay un gato en el jardín.', kr: '정원에 고양이 한 마리가 있어요.' }, { es: 'No hay leche.', kr: '우유가 없어요.' }] },
  { num: 8, titleEs: 'Los verbos -ar y el presente', titleKr: '-ar 동사와 현재 시제',
    examples: [{ es: 'Yo hablo español.', kr: '나는 스페인어를 말해요.' }, { es: 'Nosotros estudiamos mucho.', kr: '우리는 공부를 많이 해요.' }] },
  { num: 9, titleEs: 'Los verbos -er y los interrogativos I', titleKr: '-er 동사와 의문사 1',
    examples: [{ es: '¿Qué comes?', kr: '뭐 먹어?' }, { es: 'Como pan.', kr: '빵을 먹어요.' }] },
  { num: 10, titleEs: 'Los verbos -ir y los interrogativos II', titleKr: '-ir 동사와 의문사 2',
    examples: [{ es: '¿Dónde vives?', kr: '어디 살아?' }, { es: 'Vivo en Madrid.', kr: '마드리드에 살아요.' }] },
  { num: 11, titleEs: 'El gerundio y el presente progresivo', titleKr: '현재 분사와 진행형',
    examples: [{ es: 'Estoy estudiando español.', kr: '나는 스페인어를 공부하고 있어요.' }, { es: 'Ella está cocinando.', kr: '그녀는 요리하고 있어요.' }] },
  { num: 12, titleEs: 'El verbo ir y verbos irregulares I (e→ie)', titleKr: '동사 ir와 불규칙 동사 1 (e-ie)',
    examples: [{ es: 'Voy al parque.', kr: '나는 공원에 가요.' }, { es: 'Quiero un café.', kr: '커피 한 잔 원해요.' }] },
  { num: 13, titleEs: 'Verbos irregulares II (o→ue)', titleKr: '불규칙 동사 2 (o-ue)',
    examples: [{ es: 'Puedo ayudarte.', kr: '도와줄 수 있어요.' }, { es: 'Ella duerme mucho.', kr: '그녀는 잠을 많이 자요.' }] },
  { num: 14, titleEs: 'Verbos irregulares III (tener, dar)', titleKr: '불규칙 동사 3 (tener, dar)',
    examples: [{ es: 'Tengo dos hermanos.', kr: '형제가 두 명 있어요.' }, { es: 'Le doy un regalo.', kr: '그에게 선물을 줘요.' }] },
  { num: 15, titleEs: 'Verbos irregulares IV', titleKr: '불규칙 동사 4',
    examples: [{ es: 'Yo hago la comida.', kr: '내가 음식을 만들어요.' }, { es: 'Ella sale temprano.', kr: '그녀는 일찍 나가요.' }] },
  { num: 16, titleEs: 'Los adjetivos posesivos', titleKr: '소유 형용사',
    examples: [{ es: 'Mi casa es pequeña.', kr: '내 집은 작아요.' }, { es: 'Sus libros están aquí.', kr: '그들의 책이 여기 있어요.' }] },
  { num: 17, titleEs: 'Preposiciones I / preposición + pronombre', titleKr: '전치사 1 / 전치사 + 대명사',
    examples: [{ es: 'El regalo es para ti.', kr: '선물은 너를 위한 거야.' }, { es: 'Voy con ella.', kr: '나는 그녀와 함께 가요.' }] },
  { num: 18, titleEs: 'Preposiciones II (para vs. por)', titleKr: '전치사 2 (para vs por)',
    examples: [{ es: 'Este café es para ti.', kr: '이 커피는 너를 위한 거야.' }, { es: 'Viajo por España.', kr: '나는 스페인 전역을 여행해요.' }] },
  { num: 19, titleEs: 'Saber vs. conocer', titleKr: 'saber vs conocer',
    examples: [{ es: 'Sé nadar.', kr: '수영할 줄 알아요.' }, { es: 'Conozco a tu hermana.', kr: '네 여동생을 알아요.' }] },
  { num: 20, titleEs: 'El comparativo de igualdad', titleKr: '원급 비교 (동등 비교)',
    examples: [{ es: 'Ella es tan alta como yo.', kr: '그녀는 나만큼 키가 커요.' }, { es: 'Tengo tantos libros como tú.', kr: '나는 너만큼 책이 많아요.' }] },
  { num: 21, titleEs: 'El comparativo', titleKr: '비교급',
    examples: [{ es: 'Este coche es más caro que ese.', kr: '이 차가 저것보다 더 비싸요.' }, { es: 'Soy menos alto que mi padre.', kr: '나는 아버지보다 키가 덜 커요.' }] },
  { num: 22, titleEs: 'El superlativo', titleKr: '최상급',
    examples: [{ es: 'Es el libro más interesante.', kr: '가장 재미있는 책이에요.' }, { es: 'Ella es la más inteligente de la clase.', kr: '그녀는 반에서 가장 똑똑해요.' }] },
  { num: 23, titleEs: 'El objeto directo', titleKr: '직접 목적어',
    examples: [{ es: 'Lo compro.', kr: '나는 그것을 사요.' }, { es: 'La veo.', kr: '나는 그녀를 봐요.' }] },
  { num: 24, titleEs: 'El objeto indirecto', titleKr: '간접 목적어',
    examples: [{ es: 'Le doy el libro a Juan.', kr: '나는 후안에게 책을 줘요.' }, { es: 'Te escribo una carta.', kr: '너에게 편지를 써.' }] },
  { num: 25, titleEs: 'Los verbos reflexivos', titleKr: '재귀 동사',
    examples: [{ es: 'Me levanto a las siete.', kr: '나는 7시에 일어나요.' }, { es: 'Ella se ducha por la mañana.', kr: '그녀는 아침에 샤워해요.' }] },
  { num: 26, titleEs: 'Verbos de estructura inversa', titleKr: '역구조 동사 (gustar형)',
    examples: [{ es: 'Me gusta el chocolate.', kr: '나는 초콜릿을 좋아해요.' }, { es: 'Le duele la cabeza.', kr: '그는 머리가 아파요.' }] },
  { num: 27, titleEs: 'El imperativo I', titleKr: '명령형 1',
    examples: [{ es: '¡Habla más despacio!', kr: '더 천천히 말해!' }, { es: '¡Come tus verduras!', kr: '야채 먹어!' }] },
  { num: 28, titleEs: 'El imperativo II', titleKr: '명령형 2',
    examples: [{ es: '¡No hables tan rápido!', kr: '그렇게 빨리 말하지 마!' }, { es: '¡No comas eso!', kr: '그거 먹지 마!' }] },
  { num: 29, titleEs: 'El pretérito perfecto', titleKr: '현재 완료',
    examples: [{ es: 'He comido paella.', kr: '나는 빠에야를 먹어봤어요.' }, { es: '¿Has visto esta película?', kr: '이 영화 본 적 있어?' }] },
  { num: 30, titleEs: 'El pretérito indefinido I (-ar)', titleKr: '단순 과거 1 (-ar)',
    examples: [{ es: 'Ayer hablé con ella.', kr: '어제 그녀와 이야기했어요.' }, { es: 'Estudiamos toda la noche.', kr: '우리는 밤새 공부했어요.' }] },
  { num: 31, titleEs: 'El pretérito indefinido II (-er, -ir)', titleKr: '단순 과거 2 (-er, -ir)',
    examples: [{ es: 'Comí mucho ayer.', kr: '어제 많이 먹었어요.' }, { es: 'Ella salió temprano.', kr: '그녀는 일찍 나갔어요.' }] },
  { num: 32, titleEs: 'El pretérito indefinido III (irregulares)', titleKr: '단순 과거 3 (불규칙)',
    examples: [{ es: 'Fui a la playa.', kr: '해변에 갔어요.' }, { es: 'Tuve un examen difícil.', kr: '어려운 시험을 봤어요.' }] },
  { num: 33, titleEs: 'El pretérito imperfecto', titleKr: '불완료 과거',
    examples: [{ es: 'Cuando era niño, jugaba mucho.', kr: '어렸을 때, 많이 놀았어요.' }, { es: 'Vivíamos en Madrid.', kr: '우리는 마드리드에 살았었어요.' }] },
  { num: 34, titleEs: 'El futuro simple', titleKr: '단순 미래',
    examples: [{ es: 'Mañana viajaré a España.', kr: '내일 스페인으로 여행 갈 거예요.' }, { es: 'Ella estudiará medicina.', kr: '그녀는 의학을 공부할 거예요.' }] },
  { num: 35, titleEs: 'El condicional simple', titleKr: '가능법',
    examples: [{ es: 'Me gustaría viajar.', kr: '여행하고 싶을 것 같아요.' }, { es: 'Yo iría contigo.', kr: '나라면 너와 함께 갈 텐데.' }] },
  { num: 36, titleEs: 'El pluscuamperfecto y el futuro perfecto', titleKr: '과거 완료, 미래 완료',
    examples: [{ es: 'Ya había comido cuando llegaste.', kr: '네가 도착했을 때 나는 이미 먹었었어.' }, { es: 'Para mañana, habré terminado el trabajo.', kr: '내일까지 나는 일을 끝내 놓았을 거예요.' }] },
  { num: 37, titleEs: 'El se I (recíproco / sujeto impersonal)', titleKr: 'se 1 (상호 / 무인칭 주어의 se)',
    examples: [{ es: 'Se habla español aquí.', kr: '여기서는 스페인어를 써요.' }, { es: 'Se necesita paciencia.', kr: '인내심이 필요해요.' }] },
  { num: 38, titleEs: 'El se II (pasivo)', titleKr: 'se 2 (수동의 se)',
    examples: [{ es: 'Se venden libros aquí.', kr: '여기서 책이 팔려요.' }, { es: 'Se abren las puertas a las nueve.', kr: '문이 9시에 열려요.' }] },
  { num: 39, titleEs: 'El se III (involuntario)', titleKr: 'se 3 (무의지의 se)',
    examples: [{ es: 'Se me olvidó el nombre.', kr: '이름이 (나도 모르게) 잊혀졌어요.' }, { es: 'Se le cayó el vaso.', kr: '그에게서 컵이 떨어졌어요.' }] },
  { num: 40, titleEs: 'Las conjunciones', titleKr: '접속사',
    examples: [{ es: 'Quiero café, pero no tengo dinero.', kr: '커피를 원하지만 돈이 없어요.' }, { es: 'Estudio porque quiero aprender.', kr: '배우고 싶어서 공부해요.' }] },
];

// 문법 II (Unidad 41~60)
const GRAMMAR_B2_CHAPTERS = [
  { num: 41, titleEs: 'Los conectores', titleKr: '연결사',
    examples: [{ es: 'Además, tengo mucho trabajo.', kr: '게다가, 할 일이 많아요.' }, { es: 'Sin embargo, voy a intentarlo.', kr: '그렇지만, 시도해볼게요.' }] },
  { num: 42, titleEs: 'El subjuntivo I', titleKr: '접속법 1',
    examples: [{ es: 'Espero que estés bien.', kr: '네가 잘 지내길 바라.' }, { es: 'Quiero que vengas.', kr: '네가 오길 원해.' }] },
  { num: 43, titleEs: 'El subjuntivo II', titleKr: '접속법 2',
    examples: [{ es: 'Es importante que estudies.', kr: '공부하는 게 중요해.' }, { es: 'Dudo que sea verdad.', kr: '그게 사실인지 의심스러워.' }] },
  { num: 44, titleEs: 'El subjuntivo III', titleKr: '접속법 3',
    examples: [{ es: 'Busco un trabajo que me guste.', kr: '내가 좋아할 일을 찾고 있어.' }, { es: 'No hay nadie que lo sepa.', kr: '그걸 아는 사람이 없어.' }] },
  { num: 45, titleEs: 'El subjuntivo IV', titleKr: '접속법 4',
    examples: [{ es: 'Cuando llegues, llámame.', kr: '도착하면 전화해.' }, { es: 'Antes de que te vayas, hablemos.', kr: '네가 가기 전에 이야기하자.' }] },
  { num: 46, titleEs: 'El subjuntivo V', titleKr: '접속법 5',
    examples: [{ es: 'Aunque llueva, saldré.', kr: '비가 와도 나갈 거야.' }, { es: 'Iré aunque esté cansado.', kr: '피곤해도 갈 거야.' }] },
  { num: 47, titleEs: 'El subjuntivo VI', titleKr: '접속법 6',
    examples: [{ es: 'Ojalá gane la lotería.', kr: '복권에 당첨되면 좋겠다.' }, { es: 'Ojalá que llueva mañana.', kr: '내일 비가 오면 좋겠다.' }] },
  { num: 48, titleEs: 'El subjuntivo imperfecto', titleKr: '접속법 과거',
    examples: [{ es: 'Si tuviera dinero, viajaría.', kr: '돈이 있다면, 여행할 텐데.' }, { es: 'Quería que vinieras.', kr: '네가 오길 원했었어.' }] },
  { num: 49, titleEs: 'El condicional: presente y pasado', titleKr: '가정법 현재, 가정법 과거',
    examples: [{ es: 'Si tengo tiempo, te ayudo.', kr: '시간이 있으면 도와줄게.' }, { es: 'Si tuviera tiempo, te ayudaría.', kr: '시간이 있다면, 도와줄 텐데.' }] },
  { num: 50, titleEs: 'El condicional compuesto y mixto', titleKr: '가정법 과거 완료, 혼합 가정법',
    examples: [{ es: 'Si hubiera estudiado, habría aprobado.', kr: '공부했다면, 합격했을 텐데.' }, { es: 'Si hubiera ahorrado, ahora tendría dinero.', kr: '저축했다면, 지금 돈이 있을 텐데.' }] },
  { num: 51, titleEs: 'Las oraciones exclamativas', titleKr: '감탄문',
    examples: [{ es: '¡Qué bonito!', kr: '정말 예쁘다!' }, { es: '¡Cómo llueve!', kr: '비가 정말 많이 오네!' }] },
  { num: 52, titleEs: 'El artículo neutro lo', titleKr: '중성 관사 lo',
    examples: [{ es: 'Lo importante es la familia.', kr: '중요한 것은 가족이에요.' }, { es: 'No entiendo lo que dices.', kr: '네가 말하는 걸 이해 못 하겠어.' }] },
  { num: 53, titleEs: 'Los pronombres relativos I', titleKr: '관계 대명사 1',
    examples: [{ es: 'La chica que vive aquí es mi amiga.', kr: '여기 사는 여자아이는 내 친구예요.' }, { es: 'El libro que leo es interesante.', kr: '내가 읽는 책은 재미있어요.' }] },
  { num: 54, titleEs: 'Los pronombres relativos II', titleKr: '관계 대명사 2',
    examples: [{ es: 'La persona con quien hablo es mi profesor.', kr: '내가 이야기하는 사람은 내 선생님이에요.' }, { es: 'La casa en la que vivo es grande.', kr: '내가 사는 집은 커요.' }] },
  { num: 55, titleEs: 'Los relativos', titleKr: '관계사',
    examples: [{ es: 'El motivo por el que vine es simple.', kr: '내가 온 이유는 간단해요.' }, { es: 'Eso es lo que pienso.', kr: '그게 내가 생각하는 거예요.' }] },
  { num: 56, titleEs: 'Verbos de cambio I', titleKr: '변화의 동사 1',
    examples: [{ es: 'Me pongo nervioso antes del examen.', kr: '시험 전에 긴장돼요.' }, { es: 'Se volvió muy rico.', kr: '그는 아주 부자가 됐어요.' }] },
  { num: 57, titleEs: 'Verbos de cambio II', titleKr: '변화의 동사 2',
    examples: [{ es: 'Se hizo médico.', kr: '그는 의사가 됐어요.' }, { es: 'Llegó a ser presidente.', kr: '그는 대통령이 됐어요.' }] },
  { num: 58, titleEs: 'El estilo indirecto', titleKr: '화법',
    examples: [{ es: 'Dijo que vendría mañana.', kr: '내일 올 거라고 말했어요.' }, { es: 'Me preguntó si estaba bien.', kr: '나에게 괜찮은지 물었어요.' }] },
  { num: 59, titleEs: 'Los sufijos apreciativos', titleKr: '평가 접미사',
    examples: [{ es: 'Mi perrito es muy lindo.', kr: '내 작은 강아지는 정말 귀여워요.' }, { es: 'Vive en una casita.', kr: '그는 작은 집에 살아요.' }] },
  { num: 60, titleEs: 'Me gustaría...', titleKr: 'Me gustaría (바람 표현)',
    examples: [{ es: 'Me gustaría viajar a España.', kr: '스페인으로 여행 가고 싶어요.' }, { es: 'Me gustaría aprender a cocinar.', kr: '요리하는 법을 배우고 싶어요.' }] },
];
